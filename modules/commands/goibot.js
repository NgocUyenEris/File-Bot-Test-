...
module.exports.handleEvent = function({ api, event }) {
  ...
  if ((event.body.toLowerCase() == "bot chim phong có dài không") || (event.body.toLowerCase() == "bot chim phong co dai khong")) {
    return api.sendMessage("𝙑𝙪̛̀𝙖 𝙙𝙖̀𝙞 𝙫𝙪̛̀𝙖 𝙩𝙤 ", threadID);
  };
