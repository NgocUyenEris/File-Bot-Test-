...
"https://i.postimg.cc/P5sLnhdx/onehit-30-5-2016-3.gif",
   ...
   var callback = () => api.sendMessage({body:`${tag}`  + ` chetme m nè 👿`,mentions: [{tag: tag,id: Object.keys(event.mentions)[0]}],attachment: fs.createReadStream(__dirname + "/cache/puch.gif")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/puch.gif"));  
