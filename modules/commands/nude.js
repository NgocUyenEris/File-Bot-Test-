...
"https://i.imgur.com/QYGOZuK.jpg",
  ...
  var money = data.money
   ...
   var callback = () => api.sendMessage({body:`Nwng vcl❤️‍🔥\n» Số dư: -300 đô «\n📩Facebook.com/hphong07siu`,attachment: fs.createReadStream(__dirname + "/cache/5.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg")); 
